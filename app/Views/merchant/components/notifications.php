<?php
/**
 * Standardized notification component for merchant pages
 * Displays success, error, warning, and info messages with consistent styling
 */
?>
...
<?php if (session()->getFlashdata('success')): ?>
    <div class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4" role="alert">
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-xs lg:text-sm font-medium text-green-800">Success</h3>
                <div class="mt-1 text-xs lg:text-sm text-green-700">
...
<?php if (session()->getFlashdata('error')): ?>
    <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4" role="alert">
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-xs lg:text-sm font-medium text-red-800">Error</h3>
                <div class="mt-1 text-xs lg:text-sm text-red-700">
...
<?php if (session()->getFlashdata('warning')): ?>
    <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4" role="alert">
        <div class="flex items-start">
            <div class="flex-shrink-0">
...
<?php if (session()->getFlashdata('info')): ?>
    <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4" role="alert">
        <div class="flex items-start">
            <div class="flex-shrink-0">
            ...
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button type="button" class="inline-flex bg-blue-50 rounded-md p-1.5 text-blue-500 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-50 focus:ring-blue-600" onclick="this.parentElement.parentElement.parentElement.parentElement.remove()">
                        <span class="sr-only">Dismiss</span>
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
