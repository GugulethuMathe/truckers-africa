<div class="px-4 lg:px-6 py-6 lg:py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Renew Subscription</h1>
            <p class="text-gray-600 mt-2">Complete your payment to renew your <?= esc($plan['name']) ?> subscription</p>
        </div>

        <!-- Payment Summary -->
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-4">Renewal Summary</h2>

            <div class="space-y-3">
                <div class="flex justify-between">
                    <span class="text-gray-700">Plan:</span>
                    <span class="font-semibold text-gray-900"><?= esc($plan['name']) ?></span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between">
                    <span class="text-gray-700">Previous Billing Period Ended:</span>
                    <span class="text-red-600 font-medium"><?= date('M j, Y', strtotime($subscription['current_period_ends_at'])) ?></span>
                </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="text-right">
                            <div class="text-2xl font-bold text-blue-600">
                                R <?= number_format($amount_zar, 2) ?>
                            </div>
                            <div class="text-sm text-gray-500">
                                ($<?= number_format($amount_usd, 2) ?> USD)
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p class="text-sm text-gray-700">
                    ...
                    <strong>Note:</strong> This payment will renew your subscription for the next month starting from today.
                    Your next billing will occur on <?= date('M j, Y', strtotime('+1 month')) ?>.
                </p>
            </div>
        </div>
        ...
        <div class="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-green-900">Secure Payment</h3>
                    <p class="text-sm text-green-700 mt-1">
                        All payments are processed securely through PayFast using industry-standard encryption.
                    </p>
                </div>
            </div>
        </div>
