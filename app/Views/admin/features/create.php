<?= view('admin/templates/header', ['page_title' => 'Create New Feature']) ?>

<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div>
            <h2 class="text-2xl font-semibold leading-tight">Create New Feature</h2>
        </div>
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                <div class="bg-white p-6">
                    ...
                    <form action="<?= site_url('admin/features/store') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="code" name="code" value="<?= old('code') ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="e.g., UNLIMITED_LISTINGS">
