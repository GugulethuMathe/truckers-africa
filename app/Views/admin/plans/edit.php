<?= view('admin/templates/header', ['page_title' => 'Edit Plan']) ?>

<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div>
            <h2 class="text-2xl font-semibold leading-tight">Edit Plan: <?= esc($plan['name']) ?></h2>
        </div>
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                <div class="bg-white p-6">
                    ...
                    <form action="<?= site_url('admin/plans/update/' . $plan['id']) ?>" method="post">
                        <?= csrf_field() ?>

                        <div class="mb-4">
                            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Plan Name:</label>
                            <input type="text" id="name" name="name" value="<?= old('name', $plan['name']) ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="text" id="price" name="price" value="<?= old('price', $plan['price']) ?>" class="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><?= old('description', $plan['description']) ?></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" id="has_trial" name="has_trial" value="1" class="form-checkbox h-5 w-5 text-indigo-600" <?= old('has_trial', $plan['has_trial']) ? 'checked' : '' ?> onchange="toggleTrialDays()">
                                <span class="ml-2 text-gray-700">Enable Free Trial</span>
                            </label>
                        </div>

                        <div class="mb-4" id="trial_days_container" style="display: <?= old('has_trial', $plan['has_trial']) ? 'block' : 'none' ?>;">
                            <label for="trial_days" class="block text-gray-700 text-sm font-bold mb-2">Trial Days:</label>
                            <input type="number" id="trial_days" name="trial_days" value="<?= old('trial_days', $plan['trial_days']) ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="max_locations" name="max_locations"
                                           value="<?= old('max_locations', $plan_limits['max_locations'] ?? 1) ?>"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="max_listings" name="max_listings"
                                           value="<?= old('max_listings', $plan_limits['max_listings'] ?? 5) ?>"
                                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                           min="-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="max_categories" name="max_categories"
                                           value="<?= old('max_categories', $plan_limits['max_categories'] ?? 2) ?>"
                                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                           min="-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="max_gallery_images" name="max_gallery_images"
                                           value="<?= old('max_gallery_images', $plan_limits['max_gallery_images'] ?? 3) ?>"
                                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                           min="-1">
