<?= view('templates/home-header', ['page_title' => 'Admin Login', 'page_class' => 'bg-gray-100']) ?>
    ...
    <div class="w-full max-w-md px-8 py-10 bg-white rounded-lg shadow-md">
        ...
        <form action="<?= site_url('admin/login') ?>" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" required class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="admin@example.com">
            </div>
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="text-sm">
                    <a href="<?= site_url('admin/forgot-password') ?>" class="font-medium text-indigo-600 hover:text-indigo-500">Forgot your password?</a>
                </div>
            </div>
