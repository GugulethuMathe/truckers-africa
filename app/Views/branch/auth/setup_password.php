        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Welcome, <strong><?= esc($branchUser['full_name']) ?></strong>!<br>
                    Create a secure password for your branch manager account.
                </p>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm brand-color">
                            <strong>Business:</strong> <?= esc($branchUser['business_name']) ?><br>
                            <strong>Branch:</strong> <?= esc($branchUser['location_name']) ?><br>
                            <strong>Email:</strong> <?= esc($branchUser['email']) ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Password Setup Form -->
            <form class="mt-8 space-y-6" action="<?= site_url('branch/setup-password/process') ?>" method="POST">
                <?= csrf_field() ?>
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    Having trouble? Contact your business owner or <a href="mailto:support@truckersafrica.com" class="font-medium brand-color hover:underline">our support team</a>
                </p>
            </div>
        </div>
    </div>
